 ...
 *
 */
public class RobotUltrasoundPositionToTarget extends Command {
	...
	public RobotUltrasoundPositionToTarget(double distance, double speed, boolean endItNow, double timeout) {
