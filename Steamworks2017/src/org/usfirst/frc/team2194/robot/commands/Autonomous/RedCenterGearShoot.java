 ...
 *
 */
public class RedCenterGearShoot extends CommandGroup {
	// gear values
	double driveSpeed;
	double driveSpeedOrient;
	double targetPoint = 71;//69;
	// shoot values
	double reverseDistance = 30;//25;
	double shootTurnAngle = 105.9;//118;//114.5;
	double shootForwardPoint = 68.1;//65.9;

	public RedCenterGearShoot() {
		// Add Commands here:
...
//		shootTurnAngle = Robot.prefs.getDouble("RdCtrShtAngle", 112.1);
